...
def graphData(stock, MA1, MA2):
    try:
        ...
        urlToVisit = 'http://chartapi.finance.yahoo.com/instrument/1.0/{}/chartdata;type=quote;range=10y/csv'.format(stock)
        stockFile = []
    ...
    try:
        ...
        ax1.spines['buttom'].set_color('#5998ff')
        ...
        ax0.fill_begween(date[-SP:], rsi[-SP:], 30, where=(rsi[-SP:]<=30), facecolor=posCol, edgecolor=posCol, alpha=0.5)
