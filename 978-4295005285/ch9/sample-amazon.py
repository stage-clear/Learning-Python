...
db = dataset.connect('sqlit:///reviews.db')

review_url = 'https://www.amazon.com/ss/customer-review/ajax/reviews/get/'
...
def parse_reviews (reply):
    ...
    for fragment in reply.split('&&&'):
        ...
        div = html.soup.find('div', class_='review')
        if not div:
            continue
...
def get_reviews (product_id, page):
    ...
    print(review_url + 'ref=' + data['reftag'])
